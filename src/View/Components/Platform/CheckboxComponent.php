...
class CheckboxComponent extends Component
{
    ...
    public function __construct(
        ...
        readonly public bool $checkedValue = true,
    ...
    private function isChecked(): bool
    {
        if ($this->target instanceof Repository || $this->target instanceof Model) {
            ...
            return (bool) $targetValue === $this->checkedValue;
        }
    ...
    {
        return $this->id ?? $this->name ?? uniqid('checkbox_');
    }
    ...
    {
        return view('orchid-helpers::components.platform.checkbox-component');
    }
}